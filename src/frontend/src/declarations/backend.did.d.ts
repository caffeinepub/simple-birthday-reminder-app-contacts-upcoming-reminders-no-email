...
export interface _SERVICE {
  ...
  'createContact' : ActorMethod<
    ...
    undefined
  >,
  'deleteBirthdayGiftPlan' : ActorMethod<[string], undefined>,
  'deleteContact' : ActorMethod<[string], undefined>,
  'getBirthdayGiftPlan' : ActorMethod<[string], [] | [BirthdayGiftPlan]>,
  'getBirthdayGiftPlansForContact' : ActorMethod<
    [string],
    Array<BirthdayGiftPlan>
  >,
